...
function calculatePathSchwarzschild(pos0, dir0) {
	...
	//console.log(pos0.getAngleToSin(dir0), pos0.getAngleToCos(dir0));

	var r = r0;
	var dr = pos0.getAngleToCos(dir0);
	//var dr = Math.sqrt(1-L*L/(r0*r0));
	...
	while (true) {
		...
		var dir = Vec(dx, dy);
		//console.log(dir.getLength(), r*r*pos.getAngleToSin(dir));
		//console.log(Math.sqrt(1-dr*dr));
